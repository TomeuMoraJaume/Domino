...
public class Mexica extends Joc{
        ...
        public void formarParejas(boolean parejasFijas) {
            ...
            if (parejasFijas) {
                ...
                // Lógica para parejas variables (si quieres)
            }
        }
        ...
        public void jugarVariasPartidasMexica() {
            ...
            while (!hayGanador) {
                ...
                // Determinar parella guanyadora (parella la cual forma part el que ha guanyat)
                ArrayList<jugador> parejaGanadora = parejas.stream()
